...
urlpatterns = [
    ...
    path("auth/login/", crud_api.LoginAPIView.as_view(), name="api-login"),
    path("auth/logout/", crud_api.LogoutAPIView.as_view(), name="api-logout"),
    path("auth/password/", crud_api.PasswordChangeAPIView.as_view(), name="api-password"),
