...
class ParcelCRMProjectionService:
    ...
    def _build_placeholder_customer_identity(self, parcel: Parcel, crm: dict):
        lot = crm.get("lot") or parcel.lot_number or parcel.parcel_code or str(parcel.id)
        program_code = getattr(parcel.program, "code", None) or "PRG"
        first_name = self.PLACEHOLDER_CUSTOMER_FIRST_NAME
        last_name = f"{self.PLACEHOLDER_CUSTOMER_LAST_NAME_PREFIX}-{program_code}-{lot}-{parcel.id}"
    ...
    def _get_or_create_placeholder_customer(self, parcel: Parcel, crm: dict):
        ...
        customer = Customer.objects.create(
            ...
            notes=(
                ...
                f"d'identité exploitable pour la parcelle {parcel.id}."
            ),
        )
            ...
            **project_metadata,
            ...
            "crm_customer": {
                ...
                "is_placeholder": (
                    ...
                    and customer.last_name.startswith(self.PLACEHOLDER_CUSTOMER_LAST_NAME_PREFIX)
